...
We provide the code to calculate the detection results in the paper. All the code for result calculation can be found in the `evaluation` folder, and the evaluation codes are based on both C/C++ and Python.   
