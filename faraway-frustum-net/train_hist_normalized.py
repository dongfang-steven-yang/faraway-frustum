...
def preprocess_data(pointcloud_frustum_data, bb_label_data, centroids=[], width_meters=15, height_meters=20, resolution=0.1, bb_shift=75):
    ...
    for counter, (data_point, centroid) in enumerate(zip(data, centroids)):
        ...
        target_data[counter] = [labels[counter][0] + bb_shift - centroid_x, labels[counter][1], labels[counter][2] +
                                bb_shift - centroid_z, labels[counter][3], labels[counter][4], labels[counter][5], labels[counter][6] + 3.14]
...
bb_shift=75
data = pickle.load(open('/localdata/yurtsever.2/Data/faraway_frustum/data_split01_train_Car/samples.p', 'rb'))
labels = pickle.load(open('/localdata/yurtsever.2/Data/faraway_frustum/data_split01_train_Car/labels.p', 'rb'))
...
validation_data = pickle.load(open('/localdata/yurtsever.2/Data/faraway_frustum/data_split01_val_Car/samples.p', 'rb'))
validation_labels = pickle.load(open('/localdata/yurtsever.2/Data/faraway_frustum/data_split01_val_Car/labels.p', 'rb'))
...
model.save('saved_models/car_mobile_net')
