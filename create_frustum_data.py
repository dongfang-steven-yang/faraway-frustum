...
def main():
    ...
    path_frustum_data = 'data_frustum/x'
    path_frustum_labels = 'data_frustum/y'
    path_frustum = 'data_frustum'
    ...
    for sample_name in data_list:
        ...
        # test
        # print(len(clusters_cam0))
        # if len(clusters_cam0) > 1:
        #     print('test')
