...
import random
import numpy as np
from models.pre_trained.mask_rcnn.samples.coco import coco  # Import COCO config
from models.pre_trained.mask_rcnn.mrcnn import utils
import models.pre_trained.mask_rcnn.mrcnn.model as modellib

# Root directory of the project
ROOT_DIR = os.path.abspath("models/pre_trained/mask_rcnn")
