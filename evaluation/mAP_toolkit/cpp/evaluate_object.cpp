...
const int32_t N_TESTIMAGES = 3756;
...
//const int32_t MIN_HEIGHT[3]     = {1, 1, 1};     // minimum height for evaluated groundtruth/detections
//const int32_t MAX_OCCLUSION[3]  = {2, 2, 2};        // maximum occlusion level of the groundtruth used for evaluation
//const double  MAX_TRUNCATION[3] = {0.5, 0.5, 0.5}; // maximum truncation level of the groundtruth used for evaluation
...
//const double MIN_OVERLAP[3][3] = {{0.7, 0.25, 0.25}, {0.7, 0.25, 0.25}, {0.7, 0.25, 0.25}};
...
bool eval(string result_sha,Mail* mail){
  ...
  string gt_dir         = ".../cpp/label_2";
  string result_dir     = ".../cpp/results/" + result_sha;
