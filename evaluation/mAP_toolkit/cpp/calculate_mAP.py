...
def calculate_score_BEV():
    ...
    # Cyc_BEV_data = np.loadtxt(path +'/results/dt/plot/cyclist_detection_ground.txt')
        ...
        print(f'BEV Pedestrian Detection(easy,mod,hard) : {str(score_Pd_BEV_easy * 100)} + {str(score_Pd_BEV_mod * 100)} + {str(score_Pd_BEV_hard * 100)}')
    except:
    ...
    try:
        ...
        print(f'BEV Car Detection(easy,mod,hard) : {str(score_Car_BEV_easy * 100)} + {str(score_Car_BEV_mod * 100)} + {str(score_Car_BEV_hard * 100)}')
    except:
    ...
    try:
        ...
        score_Cyc_BEV_mod = score_Cyc_BEV_mod / 11
        score_Cyc_BEV_hard = score_Cyc_BEV_hard / 11
        print(f'BEV Cyc Detection(easy,mod,hard) : {str(score_Cyc_BEV_easy * 100)} + {str(score_Cyc_BEV_mod * 100)} + {str(score_Cyc_BEV_hard * 100)}')
    except:
        print('==========>cannot calculate CYC BEV')

    # with open(path +'/results/score_BEV.txt', 'w') as resulttxt:
    #     resulttxt.truncate()
    #     resulttxt.write('BEV Pedestrian Detection(easy,mod,hard) : ' + str(score_Pd_BEV_easy*100) +' '+str(score_Pd_BEV_mod*100) + ' '+ str(score_Pd_BEV_hard*100)+'\n')
    #     resulttxt.write('BEV Car Detection(easy,mod,hard) : ' + str(score_Car_BEV_easy) +' '+str(score_Car_BEV_mod) + ' '+ str(score_Car_BEV_hard) +'\n')
        #resulttxt.write('BEV Cyclist(easy,mod,hard) : ' + str(score_Cyc_BEV_easy) +' '+str(score_Cyc_BEV_mod) + ' '+ str(score_Cyc_BEV_hard) +'\n')
    print('BEV score calculation done')
    # print('score_Pd_BEV_easy: %s' %str(score_Pd_BEV_easy))
    # print('score_Pd_BEV_mod: %s' % str(score_Pd_BEV_mod))
    # print('score_Pd_BEV_hard: %s' % str(score_Pd_BEV_hard))
    # print('score_Car_BEV_easy: %s' %str(score_Car_BEV_easy))
    # print('score_Car_BEV_mod: %s' % str(score_Car_BEV_mod))
    # print('score_Car_BEV_hard: %s' % str(score_Car_BEV_hard))
    # print('score_Cyc_BEV_easy: %s' %str(score_Cyc_BEV_easy))
    # print('score_Cyc_BEV_mod: %s' % str(score_Cyc_BEV_mod))
    # print('score_Cyc_BEV_hard: %s' % str(score_Cyc_BEV_hard))
...
def calculate_socre_3D():
    ...
    try:
        ...
        print(f'3d Pedestrian Detection(easy,mod,hard) : {str(score_Pd_3d_easy*100)} + {str(score_Pd_3d_mod*100)} + {str(score_Pd_3d_hard*100)}')
    except:
    ...
    try:
        ...
        print(f'3d Car Detection(easy,mod,hard) : {str(score_Car_3d_easy*100)} + {str(score_Car_3d_mod*100)} + {str(score_Car_3d_hard*100)}')
    except:
    ...
    try:
        ...
        print(f'3d Cyc Detection(easy,mod,hard) : {str(score_Cyc_3d_easy*100)} + {str(score_Cyc_3d_mod*100)} + {str(score_Cyc_3d_hard*100)}')
    except:
        print('==========>cannot calculate Cyc 3D')


    # with open(path +'/results/score_3d.txt', 'w') as resulttxt:
    #     resulttxt.truncate()
    #     resulttxt.write('3d Pedestrian Detection(easy,mod,hard) : ' + str(score_Pd_3d_easy*100) +' '+str(score_Pd_3d_mod*100) + ' '+str(score_Pd_3d_hard*100)+'\n')
    #     resulttxt.write('3d car Detection(easy,mod,hard) : ' + str(score_Car_3d_easy*100) +' '+str(score_Car_3d_mod*100) + ' '+str(score_Car_3d_hard*100)+'\n')
...
def main():
    ...
    calculate_socre_3D()
    # calculate_score_2D()
    # print('Results were written in txt format in the path : /results')
